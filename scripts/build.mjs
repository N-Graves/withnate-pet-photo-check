...
const result = await build({
  ...
  outfile: "dist/pet-photo-check.js",
  bundle: true,
  format: "iife",
  target: "es2020",
  platform: "browser",
...
await build({
  ...
  outfile: "dist/pet-photo-check.css",
  bundle: true,
  minify: false,
  banner: { css: banner },
});

const out = result.metafile.outputs["dist/pet-photo-check.js"];
const css = await readFile(new URL("../dist/pet-photo-check.css", import.meta.url));
